...
App({
  ...
  onPageLoad: function (event) {
    ...
    if (!this.globalData.tradingNotLoading){
    ...
    this.sendRequest({
      ...
      success: function(res){
        ...
        for (let k in cart_info) {
          ...
          if (goods && goods[item.model_id].stock < item.num){
            isNotEnouth = false;
...
    return s;
  ...
  goodsFootPrint: function(){
    this.turnToPage('/eCommerce/pages/goodsFootPrint/goodsFootPrint');
  },
  goodsFavorites: function(){
    this.turnToPage('/eCommerce/pages/goodsFavorites/goodsFavorites');
  },
  ...
  setSystemInfoData: function (res) {
    ...
    subPackagePages: {"customPackage1":["page10006","page10008","page10010","page10012","page10016","page10018"],"customPackage2":["page10005","page10007","page10009","page10011","page10013","page10015","page10017"]},
    globalData:{
    appId: '3ZQe3UYNUN',
    historyDataId: '115679',
