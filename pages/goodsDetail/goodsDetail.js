...
Page({
  ...
  onShareAppMessage: function(){
    ...
    let that = this,
      ...
      path = '/pages/goodsDetail/goodsDetail?detail=' + goodsId + '&contact=' + contact + (franchiseeId ? '&franchisee=' + franchiseeId + '&cart_num=' + cartGoodsNum : '') + urlSeckill + urlPromotion + (app.globalData.pageShareKey ? ('&pageShareKey=' + app.globalData.pageShareKey) : '');
  ...
  goFootPrintDetail: function(event){
    let _this = this;
    this.hideFootPrint();
    app.turnToPage('/pages/goodsDetail/goodsDetail?detail=' + event.currentTarget.dataset.id + '&contact=' + _this.data.contact + '&hidestock=' + _this.data.hidestock + '&isShowVirtualPrice=' + _this.data.isShowVirtualPrice);
  },
