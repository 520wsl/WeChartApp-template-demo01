...
Page({
  ...
  onShareAppMessage: function (e) {
    ...
    if (e.from == 'button') {
      ...
      url = '/eCommerce/pages/joinGroupDetail/joinGroupDetail?detail=' + groupInfo.goods_id + '&teamToken=' + teamToken + franchisee + (app.globalData.pageShareKey ? ('&pageShareKey=' + app.globalData.pageShareKey) : '');
